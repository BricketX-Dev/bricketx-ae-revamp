...
export default function HeroSection() {
  return (
    <section
      id="hero"
      className="relative min-h-[92vh] lg:min-h-screen flex items-center bg-[#07090e] text-white overflow-hidden pt-28 pb-20"
    >
      {/* 1. Cinematic Skyline with Slow-Zoom Background */}
      <div
        className="absolute inset-0 z-0 bg-cover bg-right md:bg-center opacity-40 mix-blend-luminosity hero-zoom-bg"
        style={{
          backgroundImage:
      ...
      <div className="absolute inset-0 z-0 bg-gradient-to-r from-[#07090e] via-[#07090e]/90 md:via-[#07090e]/75 to-transparent" />
      <div className="absolute inset-0 z-0 bg-gradient-to-t from-[#07090e] via-transparent to-[#07090e]/70" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-3xl">
          {/* Stagger Item 1: Category Badge (Instant reveal) */}
          <div
          ...
          >
            <span className="relative flex h-2 w-2">
              ...
              <span className="relative inline-flex rounded-full h-2 w-2 bg-[#c39967]"></span>
            </span>
      ...
      {/* Floating Dubai Skyline Location Tag */}
      <div
        className="hero-fade-in hidden xl:flex absolute bottom-12 right-12 z-10 items-center gap-3 text-xs tracking-widest uppercase text-white/40 border-l border-white/20 pl-4 py-1"
