  ...
  capabilitiesTape: [
    {
      ...
      desc: "Full technical scoping, architecture blueprints, budget forecasting, and dependency mapping before writing code.",
      link: "/contact",
      linkText: "Request Planning Scope",
      img: "/images/capabilities/project-management/tech-planning.webp",
    },
    {
      title: "Digital Project Management",
      desc: "Single-vendor coordination of engineers, agile sprints, and critical-path delivery for web platforms and software.",
      link: "/contact",
      linkText: "Explore Management Scope",
      img: "/images/capabilities/project-management/digital-projects.webp",
    },
    {
      title: "Product Development Management",
      desc: "Feature backlog prioritization, user story mapping, and milestone steering for digital products and mobile apps.",
      link: "/contact",
      linkText: "View Product Workflow",
      img: "/images/capabilities/project-management/product-management.webp",
    },
    {
      title: "Quality Assurance & Testing",
      desc: "Rigorous functional QA, user acceptance testing (UAT), load audits, and vulnerability verification before launch.",
      link: "/contact",
      linkText: "See QA Standards",
      img: "/images/capabilities/project-management/quality-assurance.webp",
    },
    {
      title: "Project Execution & Delivery",
      desc: "Day-to-day developer and contractor alignment under disciplined sprint cadences with zero vendor silos.",
      link: "/contact",
      linkText: "Review Delivery Model",
      img: "/images/capabilities/project-management/project-execution.webp",
    },
    {
      title: "Support & SLA Maintenance",
      desc: "Guaranteed post-launch support windows, continuous uptime monitoring, and SLA retainer maintenance.",
      link: "/contact",
      linkText: "View SLA Plans",
      img: "/images/capabilities/project-management/support-maintenance.webp",
    },
  ],
  capabilities: [
    {
